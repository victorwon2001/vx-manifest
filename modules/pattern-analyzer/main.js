module.exports = (function (root) {
  ...
  function getShippingModeTheme(isCancelMode) {
    return isCancelMode ? {
      ...
      progressBackground: "linear-gradient(180deg,rgba(45,95,212,.98) 0%,rgba(31,73,182,.98) 100%)",
    };
  }
  ...
  function createPopupHtml() {
    ...
    return [
      ...
      ".content{display:none}.content.active{display:grid;gap:12px}.message{padding:12px 14px;border-radius:10px;margin-bottom:16px;font-weight:700;border:1px solid var(--tm-border);background:var(--tm-surface-alt)}.message.error{background:rgba(201,81,81,.1);color:var(--tm-danger);border-color:rgba(201,81,81,.16)}.message.success{background:rgba(45,95,212,.08);color:var(--tm-success);border-color:rgba(45,95,212,.16)}",
      ...
      ".tm-ui-table th,.tm-ui-table td{text-align:center}.tm-ui-table td.left,.tm-ui-table th.left{text-align:left}tr.clickable{cursor:pointer}#pattern-table-body tr.tone-even td{background:#f7f8f9}#pattern-table-body tr.tone-odd td{background:#edf1f4}#pattern-table-body tr.tone-leftover td{background:#fcecec!important}tfoot tr{background:var(--tm-surface-alt);font-weight:700}",
      ".badge{display:inline-flex;align-items:center;gap:4px;padding:4px 8px;border-radius:999px;font-size:12px;font-weight:700;margin:2px;border:1px solid var(--tm-border)}.badge.complete{background:rgba(45,95,212,.08);color:var(--tm-success);border-color:rgba(45,95,212,.16)}.badge.pending{background:rgba(201,81,81,.08);color:var(--tm-warning);border-color:rgba(201,81,81,.14)}",
