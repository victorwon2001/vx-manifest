module.exports = (function (root) {
  ...
  function createPopupHtml() {
    ...
    return [
      ...
      sharedCss,
      "html,body{margin:0;padding:0}body{padding:20px;box-sizing:border-box;background:#f9f9f9}",
      ".shell{display:grid;gap:14px}.hero{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:16px;align-items:end;padding:18px 20px;background:#ffffff;border:1px solid var(--tm-border);border-radius:16px}.hero-copy{display:grid;gap:8px}.hero h2{margin:0;font-size:28px;line-height:1.04;letter-spacing:-.04em;color:var(--tm-text)}.hero p{margin:0;color:var(--tm-muted);font-size:12px;line-height:1.6;max-width:760px}.hero-meta{display:flex;align-items:flex-end;justify-content:flex-end;gap:8px;flex-wrap:wrap}",
      ".card{margin:0;border:1px solid var(--tm-border);border-radius:14px;background:var(--tm-surface);box-shadow:none}.controls,.filters,.actions{display:flex;gap:12px;flex-wrap:wrap;align-items:center;padding:14px 16px}.controls{justify-content:space-between}.controls-main{display:flex;gap:12px;flex-wrap:wrap;align-items:flex-end;flex:1}.controls-main>label,.filters>label{display:grid;gap:6px;color:var(--tm-muted);font-weight:700}.controls-extra{display:flex;gap:8px;flex-wrap:wrap;align-items:center}.actions{justify-content:flex-end}.card.scrollable{overflow:auto}",
      ".tabs{display:flex;gap:18px;padding:0 4px;border-bottom:1px solid var(--tm-border)}.tab{height:42px;padding:0 2px;border:0;border-bottom:2px solid transparent;border-radius:0;background:transparent;color:var(--tm-muted);cursor:pointer;font-weight:800}.tab.active{color:var(--tm-primary-strong);border-bottom-color:var(--tm-primary-strong)}",
      ".content{display:none}.content.active{display:block}.message{padding:12px 14px;border-radius:10px;margin-bottom:16px;font-weight:700;border:1px solid var(--tm-border);background:var(--tm-surface-alt)}.message.error{background:#fbefee;color:var(--tm-danger);border-color:#e2c3c1}.message.success{background:#edf5f1;color:var(--tm-success);border-color:#d1e2da}",
      ".info{display:inline-flex;align-items:center;padding:4px 10px;border-radius:999px;background:var(--tm-surface-alt);border:1px solid var(--tm-border);color:var(--tm-muted);font-size:11px;font-weight:700}.summary{display:none;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:10px;margin:0;padding:0}",
      ".summary-item{background:var(--tm-surface-alt);border:1px solid var(--tm-border);border-radius:10px;padding:12px 14px}.summary-item .label{display:block;font-size:11px;color:var(--tm-muted);margin-bottom:4px;text-transform:uppercase;letter-spacing:.08em}.summary-item .value{font-size:18px;font-weight:800}.tags{display:flex;gap:6px;flex-wrap:wrap}.tag{display:inline-flex;align-items:center;padding:3px 8px;border-radius:999px;background:var(--tm-surface-alt);color:var(--tm-primary-strong);font-size:11px;border:1px solid var(--tm-border)}",
      ...
      ".stats{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-bottom:14px}.stat{background:var(--tm-surface-alt);border:1px solid var(--tm-border);border-radius:10px;padding:10px;text-align:center}.stat .label{font-size:11px;color:var(--tm-muted);text-transform:uppercase;letter-spacing:.08em}.stat .value{font-size:20px;font-weight:800}.stat .value.click{cursor:pointer;color:var(--tm-primary-strong)}.progress{height:14px;background:var(--tm-surface-alt);border-radius:999px;overflow:hidden;margin-bottom:14px;border:1px solid var(--tm-border)}.progress > div{height:100%;width:0;background:linear-gradient(180deg,rgba(92,105,112,.98) 0%,rgba(69,90,100,.98) 100%);transition:width .2s ease}.log{max-height:220px;overflow:auto}.log-item{padding:4px 0;border-bottom:1px solid rgba(255,255,255,.08)}.log-item:last-child{border-bottom:none}.log-item.success{color:#d4ece1}.log-item.error{color:#f0c2bf}",
      ".list{max-height:260px;overflow:auto;border:1px solid var(--tm-border);border-radius:10px;margin-bottom:12px;background:var(--tm-surface)}.list-item{padding:8px 10px;border-bottom:1px solid var(--tm-border);font-family:Consolas,'Courier New',monospace}.list-item:nth-child(odd){background:var(--tm-surface-alt)}.list-item:last-child{border-bottom:none}.textarea{width:100%;font-family:Consolas,'Courier New',monospace}.success{display:none;margin-bottom:12px;padding:10px 12px;border-radius:10px;background:#edf5f1;color:var(--tm-success);font-weight:700;border:1px solid #d1e2da}",
      "#print-section{display:none}@media print{body{padding:0;background:#fff}.hero,.controls,.tabs,.filters,.actions,.overlay{display:none!important}#print-section{display:block!important}}@media (max-width:980px){body{padding:14px}.hero{grid-template-columns:1fr;align-items:flex-start}.hero-meta{justify-content:flex-start}.controls{flex-direction:column;align-items:flex-start}.controls-main,.controls-extra{width:100%}.tabs{gap:12px}}</style></head><body class='tm-ui-root tm-ui-popup' data-tm-density='normal'>",
      "<div class='shell'>",
      "<div class='hero'><div class='hero-copy'><span class='tm-ui-kicker'>패턴 작업</span><h2>" + MODULE_NAME + "</h2><p>차수 데이터를 묶어 반복 패턴을 찾고, 송장 추출과 종합 출고를 같은 흐름 안에서 처리합니다.</p></div><div class='hero-meta'><span id='data-info' class='info tm-ui-badge'>데이터 정보: 없음</span></div></div><div id='message-root'></div>",
