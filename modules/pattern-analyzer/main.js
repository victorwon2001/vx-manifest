module.exports = (function (root) {
  ...
  function createPopupHtml() {
    ...
    return [
      ...
      ".shell{display:grid;gap:12px}.hero{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:14px;align-items:end;padding:14px 16px;background:#ffffff;border:1px solid var(--tm-border);border-radius:16px}.hero-copy{display:grid;gap:6px}.hero h2{margin:0;font-size:24px;line-height:1.06;letter-spacing:-.04em;color:var(--tm-text)}.hero p{margin:0;color:#495255;font-size:13px;line-height:1.58;max-width:640px}.hero-meta{display:flex;align-items:flex-end;justify-content:flex-end;gap:8px;flex-wrap:wrap}",
      ...
      ".stats{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-bottom:12px}.stat{background:var(--tm-surface-alt);border:1px solid var(--tm-border);border-radius:10px;padding:10px;text-align:center}.stat .label{font-size:12px;color:#4f5758;text-transform:uppercase;letter-spacing:.08em}.stat .value{font-size:18px;font-weight:800;color:var(--tm-text)}.stat .value.click{cursor:pointer;color:var(--tm-primary-strong)}.progress{height:14px;background:var(--tm-surface-alt);border-radius:999px;overflow:hidden;margin-bottom:12px;border:1px solid var(--tm-border)}.progress > div{height:100%;width:0;background:linear-gradient(180deg,rgba(92,105,112,.98) 0%,rgba(69,90,100,.98) 100%);transition:width .2s ease}.log{max-height:220px;overflow:auto}.log-item{padding:4px 0;border-bottom:1px solid rgba(45,52,53,.08);color:#4d5658}.log-item:last-child{border-bottom:none}.log-item.success{color:var(--tm-success)}.log-item.error{color:var(--tm-danger)}",
