module.exports = (function (root) {
  ...
  function createPopupHtml() {
    ...
    return [
      ...
      sharedCss,
      "html,body{margin:0;padding:0}body{padding:24px;box-sizing:border-box;background:radial-gradient(circle at top left,rgba(37,99,235,.12),transparent 28%),linear-gradient(180deg,#fbfdff 0%,#eef3f7 100%)}",
      ".shell{display:grid;gap:16px}.hero{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:18px;align-items:end;padding:24px 26px;background:linear-gradient(180deg,rgba(255,255,255,.99) 0%,rgba(247,250,252,.96) 100%);border:1px solid rgba(219,227,239,.92);border-radius:24px;box-shadow:0 22px 56px rgba(15,23,42,.12)}.hero-copy{display:grid;gap:10px}.hero h2{margin:0;font-size:32px;line-height:1;letter-spacing:-.04em}.hero p{margin:0;color:var(--tm-muted);font-size:13px;line-height:1.6;max-width:760px}.hero-meta{display:flex;align-items:flex-end;justify-content:flex-end;gap:8px;flex-wrap:wrap}",
      ".card{margin:0}.controls,.filters,.actions{display:flex;gap:12px;flex-wrap:wrap;align-items:center;padding:16px 18px}.controls{justify-content:space-between}.controls-main{display:flex;gap:12px;flex-wrap:wrap;align-items:flex-end;flex:1}.controls-extra{display:flex;gap:8px;flex-wrap:wrap;align-items:center}.actions{justify-content:flex-end}.card.scrollable{overflow:auto;border-radius:20px}",
      ".tabs{display:flex;gap:8px}.tab{height:40px;padding:0 18px;border:1px solid var(--tm-border);border-radius:999px;background:rgba(255,255,255,.9);color:var(--tm-muted);cursor:pointer;font-weight:800;box-shadow:0 8px 18px rgba(15,23,42,.06)}.tab.active{background:linear-gradient(180deg,#3174ff 0%,#1d4ed8 100%);color:#fff;border-color:#1d4ed8}",
      ".content{display:none}.content.active{display:block}.message{padding:12px 14px;border-radius:8px;margin-bottom:16px;font-weight:700}.message.error{background:#fef2f2;color:var(--tm-danger)}.message.success{background:#edf9f0;color:var(--tm-success)}",
      ".info{display:inline-flex;align-items:center;padding:7px 12px;border-radius:999px;background:rgba(255,255,255,.92);border:1px solid var(--tm-border);color:var(--tm-muted);font-size:12px;font-weight:700}.summary{display:none;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:10px;margin:0;padding:14px 16px}",
      ".summary-item{background:var(--tm-surface-alt);border:1px solid var(--tm-border);border-radius:8px;padding:10px 12px}.summary-item .label{display:block;font-size:12px;color:var(--tm-muted);margin-bottom:4px}.summary-item .value{font-size:16px;font-weight:700}.tags{display:flex;gap:6px;flex-wrap:wrap}.tag{display:inline-flex;align-items:center;padding:2px 8px;border-radius:999px;background:#eff6ff;color:var(--tm-primary);font-size:12px}",
      "td.left{text-align:left}tr.clickable{cursor:pointer}tr:nth-child(even){background:#fbfcfe}tr.leftover{background:#fef2f2}tfoot tr{background:#f1f5f9;font-weight:700}",
      ".badge{display:inline-flex;align-items:center;gap:4px;padding:3px 8px;border-radius:999px;font-size:12px;font-weight:700;margin:2px}.badge.complete{background:#edf9f0;color:var(--tm-success)}.badge.pending{background:#fff7ed;color:var(--tm-warning)}",
      ".link{color:var(--tm-primary);text-decoration:underline;cursor:pointer;font-weight:700}.multi{position:relative;min-width:220px}.multi-selected{height:36px;padding:0 12px;border:1px solid var(--tm-border);border-radius:8px;background:var(--tm-surface);display:flex;align-items:center;justify-content:space-between;cursor:pointer}.multi-badges{display:flex;gap:6px;flex-wrap:wrap;margin-top:6px}.multi-badge{display:inline-flex;align-items:center;background:#eff6ff;border-radius:999px;padding:2px 8px;font-size:12px}.multi-badge-remove{margin-left:4px;cursor:pointer;font-weight:700}.multi-dropdown{display:none;position:absolute;left:0;right:0;top:100%;margin-top:4px;background:var(--tm-surface);border:1px solid var(--tm-border);border-radius:10px;box-shadow:var(--tm-shadow);z-index:10;max-height:260px;overflow:auto}.multi-dropdown.show{display:block}.multi-search{padding:8px;border-bottom:1px solid var(--tm-border);background:var(--tm-surface);position:sticky;top:0}.multi-search input{width:100%}.multi-option{display:flex;gap:8px;align-items:center;padding:8px 10px;border-bottom:1px solid #f1f5f9}.multi-controls{display:flex;justify-content:space-between;align-items:center;padding:8px 10px;background:var(--tm-surface-alt);position:sticky;bottom:0}.multi-actions{display:flex;gap:6px}.multi-action{height:28px;padding:0 8px;border:1px solid var(--tm-border);background:var(--tm-surface);border-radius:8px;cursor:pointer}",
      ".overlay{z-index:1000}.overlay[style*='display: flex'],.overlay[style*='display:flex']{display:flex!important}.invoice-modal{width:min(560px,92vw)}.close{border:none;background:none;font-size:22px;cursor:pointer;color:var(--tm-muted)}",
      ".stats{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-bottom:14px}.stat{background:var(--tm-surface-alt);border:1px solid var(--tm-border);border-radius:8px;padding:10px;text-align:center}.stat .label{font-size:12px;color:var(--tm-muted)}.stat .value{font-size:20px;font-weight:700}.stat .value.click{cursor:pointer;color:var(--tm-primary)}.progress{height:18px;background:#e2e8f0;border-radius:999px;overflow:hidden;margin-bottom:14px}.progress > div{height:100%;width:0;background:var(--tm-success);transition:width .2s ease}.log{max-height:220px;overflow:auto}.log-item{padding:4px 0;border-bottom:1px solid rgba(255,255,255,.08)}.log-item:last-child{border-bottom:none}.log-item.success{color:#86efac}.log-item.error{color:#fca5a5}",
      ".list{max-height:260px;overflow:auto;border:1px solid var(--tm-border);border-radius:8px;margin-bottom:12px}.list-item{padding:7px 10px;border-bottom:1px solid #f1f5f9;font-family:Consolas,'Courier New',monospace}.list-item:nth-child(odd){background:var(--tm-surface-alt)}.list-item:last-child{border-bottom:none}.textarea{width:100%;font-family:Consolas,'Courier New',monospace}.success{display:none;margin-bottom:12px;padding:8px 10px;border-radius:8px;background:#edf9f0;color:var(--tm-success);font-weight:700}",
      "#print-section{display:none}@media print{body{padding:0;background:#fff}.hero,.controls,.tabs,.filters,.actions,.overlay{display:none!important}#print-section{display:block!important}}@media (max-width:980px){body{padding:16px}.hero{grid-template-columns:1fr;align-items:flex-start}.hero-meta{justify-content:flex-start}.controls{flex-direction:column;align-items:flex-start}.controls-main,.controls-extra{width:100%}}</style></head><body class='tm-ui-root tm-ui-popup' data-tm-density='normal'>",
      "<div class='shell'>",
      "<div class='hero'><div class='hero-copy'><span class='tm-ui-kicker'>Pattern Workspace</span><h2>" + MODULE_NAME + "</h2><p>차수 데이터를 묶어 반복 패턴을 찾고, 송장 추출과 종합 출고를 같은 흐름 안에서 처리합니다.</p></div><div class='hero-meta'><span id='data-info' class='info tm-ui-badge'>데이터 정보: 없음</span></div></div><div id='message-root'></div>",
