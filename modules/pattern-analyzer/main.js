module.exports = (function (root) {
  ...
  function createPopupHtml() {
    ...
    return [
      ...
      sharedCss,
      "html,body{margin:0;padding:0}body{padding:20px;box-sizing:border-box}",
      ".header{display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;padding:14px 16px}.header h2{margin:0;font-size:24px}",
      ".card{margin-bottom:16px}.controls,.filters,.actions{display:flex;gap:12px;flex-wrap:wrap;align-items:center;padding:14px 16px}.actions{justify-content:flex-end}.card.scrollable{overflow:auto}",
      ".tabs{display:flex;gap:6px;margin-bottom:16px}.tab{height:38px;padding:0 18px;border:1px solid var(--tm-border);border-radius:10px 10px 0 0;background:var(--tm-surface-alt);color:var(--tm-muted);cursor:pointer;font-weight:700}.tab.active{background:var(--tm-primary);color:#fff;border-color:var(--tm-primary)}",
      ...
      ".info{display:inline-flex;align-items:center;padding:5px 10px;border-radius:999px;background:var(--tm-surface-alt);border:1px solid var(--tm-border);color:var(--tm-muted);font-size:12px}.summary{display:none;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:10px;margin-bottom:16px;padding:14px 16px}",
      ...
      "#print-section{display:none}@media print{body{padding:0;background:#fff}.header,.controls,.tabs,.filters,.actions,.overlay{display:none!important}#print-section{display:block!important}}</style></head><body class='tm-ui-root tm-ui-popup' data-tm-density='normal'>",
      "<div class='header tm-ui-toolbar'><h2>" + MODULE_NAME + "</h2></div><div id='message-root'></div>",
      "<div class='card controls tm-ui-card tm-ui-toolbar'><label for='date-input'>출력일</label><input type='date' id='date-input'><div><label>판매처</label><div id='site-multiselect' class='multi'><div class='multi-selected'><span class='multi-text'>전체</span><span>▼</span></div><div class='multi-badges'></div></div></div><div><label>택배사</label><div id='expr-multiselect' class='multi'><div class='multi-selected'><span class='multi-text'>전체</span><span>▼</span></div><div class='multi-badges'></div></div></div><button id='search-button' class='tm-ui-btn tm-ui-btn--primary'>조회</button><span id='data-info' class='info tm-ui-badge'>데이터 정보: 없음</span></div>",
