module.exports = (function (root) {
  ...
  const STYLE_TEXT = [
    ...
    "#stockMoveGuiContainer .tm-stock-input-card,#stockMoveGuiContainer .tm-stock-running-card,#stockMoveGuiContainer .tm-stock-report-card{margin:12px 14px 0;padding:14px 16px}",
    "#stockMoveGuiContainer textarea{width:100%;height:160px;font-size:12px;font-family:Consolas,'Courier New',monospace}",
