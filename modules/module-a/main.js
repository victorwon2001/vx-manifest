module.exports = (function (root) {
  ...
  function applyStyles(doc) {
    ...
    const css = [
      ...
      "#" + PANEL_ID + " .tm-toolbar{display:grid;gap:8px;padding:0;background:transparent;border:0;box-shadow:none}",
      "#" + PANEL_ID + " .tm-toolbar-hero{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:flex-end;padding:14px 16px;border:1px solid var(--tm-border);border-radius:14px;background:var(--tm-surface);box-shadow:none}",
      ...
      "#" + PANEL_ID + " .tm-toolbar-controls{display:flex;align-items:flex-end;gap:4px;flex-wrap:wrap;justify-content:flex-start;padding:10px 12px;border:1px solid var(--tm-border);border-radius:12px;background:var(--tm-surface-alt)}",
      "#" + PANEL_ID + " .tm-toolbar-actions{display:flex;align-items:center;gap:4px;flex-wrap:wrap;justify-content:flex-end;padding:10px 12px;border:1px solid var(--tm-border);border-radius:12px;background:var(--tm-surface)}",
      ...
      "#" + PANEL_ID + " button{height:30px;padding:0 10px;border-radius:8px;cursor:pointer;font-size:12px;line-height:1}",
      "#" + PANEL_ID + " button:hover{filter:none}",
      "#" + PANEL_ID + " button:active{transform:none}",
      ...
      "#" + PANEL_ID + " .tm-selection-line{margin-top:2px;padding:10px 12px;color:var(--tm-muted);line-height:1.45;border:1px solid var(--tm-border);border-radius:12px;background:var(--tm-surface-alt)}",
