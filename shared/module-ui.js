(function (root, factory) {
  ...
  function buildModuleUiCss() {
    return [
      ...
      ".tm-ui-root .tm-ui-shell{display:grid;gap:var(--tm-space-3)}",
      ".tm-ui-root .tm-ui-toolbar{display:flex;gap:var(--tm-space-3);align-items:center;flex-wrap:wrap;padding:14px 16px;background:var(--tm-surface);border:1px solid var(--tm-border);border-radius:var(--tm-radius);box-shadow:none}",
      ".tm-ui-root .tm-ui-panel-head{display:grid;gap:8px;width:100%;padding:16px 18px;border-bottom:1px solid var(--tm-border);background:var(--tm-surface)}",
      ...
      ".tm-ui-root .tm-ui-title{margin:0;font-size:clamp(18px,2vw,22px);line-height:1.15;font-weight:800;letter-spacing:-.03em;color:var(--tm-text)}",
      ".tm-ui-root .tm-ui-subtitle{margin:0;color:var(--tm-muted);font-size:12px;line-height:1.55}",
      ...
      ".tm-ui-root .tm-ui-statusbar{display:flex;gap:10px;align-items:center;flex-wrap:wrap;padding:10px 12px;border:1px solid var(--tm-border);border-radius:var(--tm-radius-sm);background:var(--tm-surface-alt)}",
      ".tm-ui-root .tm-ui-inline-note{display:inline-flex;align-items:center;gap:6px;padding:0;background:transparent;color:var(--tm-muted);font-size:11px;font-weight:700;letter-spacing:.04em;text-transform:uppercase}",
      ".tm-ui-root .tm-ui-kpis{display:grid;grid-template-columns:repeat(auto-fit,minmax(120px,1fr));gap:var(--tm-space-3)}",
      ".tm-ui-root .tm-ui-kpi{padding:14px 16px;border:1px solid var(--tm-border);border-radius:var(--tm-radius);background:var(--tm-surface-alt)}",
      ...
      ".tm-ui-root .tm-ui-btn,.tm-ui-root button{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:var(--tm-control-height);padding:0 14px;border:1px solid var(--tm-primary-strong);border-radius:var(--tm-radius-sm);background:var(--tm-accent-wash);color:#fff;font:inherit;font-weight:700;cursor:pointer;text-decoration:none;box-shadow:none;transition:transform .16s ease, background-color .16s ease, border-color .16s ease, color .16s ease}",
      ...
      ".tm-ui-root .tm-ui-table th,.tm-ui-root .tm-ui-table td,.tm-ui-root table th,.tm-ui-root table td{border-bottom:1px solid var(--tm-border);padding:10px 12px;font-size:12px;vertical-align:middle}",
      ".tm-ui-root .tm-ui-table th,.tm-ui-root table th{background:var(--tm-surface-alt);color:var(--tm-muted);font-weight:800;font-size:11px;letter-spacing:.06em;text-transform:uppercase}",
      ...
      ".tm-ui-root .tm-ui-modal__head,.tm-ui-root .tm-ui-modal__foot{display:flex;align-items:center;justify-content:space-between;gap:var(--tm-space-2);padding:16px 18px;background:var(--tm-surface);border-bottom:1px solid var(--tm-border)}",
